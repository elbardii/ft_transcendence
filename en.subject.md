...
- [II Preamble](#chapter-ii-preamble)
...
- [V Project Ideas and Examples](#chapter-v-project-ideas-and-examples)
...
- [VI Readme Requirements](#chapter-vi-readme-requirements)
- [VII Bonus part](#chapter-vii-bonus-part)
...
> - Advanced chat features require the basic chat functionality from the "User interaction" module. The "Invite users to play games directly from chat" and "Game/tournament notifications in chat" features also require that at least one game be implemented first.
...
- **Major (2 pts):** Allow users to interact with other users. The minimum requirements are:
  - A basic chat system (send/receive messages between users).
  - A profile system (view user information).
  - A friends system (add/remove friends, see friends list).
- **Major (2 pts):** A public API to interact with the database with a secured API key, rate limiting, documentation, and at least 5 endpoints:
  - `GET /api/{something}`
  - `POST /api/{something}`
  - `PUT /api/{something}`
...
- **Minor (1 pt):** File upload and management system.
...
- **Minor (1 pt):** Support for multiple languages (at least 3 languages).
  - Implement i18n (internationalization) system.
  - At least 3 complete language translations.
  - Language switcher in the UI.
  - All user-facing text must be translatable.
- **Minor (1 pt):** Right-to-left (RTL) language support.
...
- **Minor (1 pt):** Support for additional browsers.
...
- **Minor (1 pt):** Game statistics and match history (requires a game module).
...
- **Minor (1 pt):** Implement remote authentication with OAuth 2.0 (Google, GitHub, 42, etc.).
...
- **Major (2 pts):** An organization system:
...
- **Minor (1 pt):** Implement a complete 2FA (Two-Factor Authentication) system for the users.
...
- **Major (2 pts):** Implement a complete RAG (Retrieval-Augmented Generation) system.
...
- **Major (2 pts):** Implement a complete LLM system interface.
  - Generate text and/or images based on user input.
  - Handle streaming responses properly.
  - Implement error handling and rate limiting.
- **Major (2 pts):** Recommendation system using machine learning.
  - Personalized recommendations based on user behavior.
  - Collaborative filtering or content-based filtering.
  - Continuously improve recommendations over time.
- **Minor (1 pt):** Content moderation AI (auto moderation, auto deletion, auto warning, etc.).
...
- **Major (2 pts):** Implement a complete web-based game where users can play against each other.
...
- **Major (2 pts):** Remote players — Enable two players on separate computers to play the same game in real-time.
...
- **Major (2 pts):** Add another game with user history and matchmaking.
...
- **Major (2 pts):** Implement advanced 3D graphics using a library like Three.js or Babylon.js.
  - Create an immersive 3D environment.
  - Implement advanced rendering techniques.
  - Ensure smooth performance and user interaction.
- **Minor (1 pt):** Advanced chat features (enhances the basic chat from "User interaction" module).
  ...
  > [!NOTE]
  > This module enhances the basic chat system from the "Allow users to interact" module. You cannot claim this module without having implemented the basic chat first. The "Invite users to play games directly from chat" and "Game/tournament notifications in chat" features also require that at least one game (see "Gaming and user experience" section) be implemented.
- **Minor (1 pt):** Implement a tournament system.
...
- **Minor (1 pt):** Game customization options.
...
- **Minor (1 pt):** A gamification system to reward users for their actions.
...
- **Minor (1 pt):** Implement spectator mode for games.
...
### IV.7 Devops
- **Major (2 pts):** Infrastructure for log management using ELK (Elasticsearch, Logstash, Kibana).
...
- **Major (2 pts):** Monitoring system with Prometheus and Grafana.
...
- **Major (2 pts):** Advanced analytics dashboard with data visualization.
  - Interactive charts and graphs (line, bar, pie, etc.).
  - Real-time data updates.
  - Export functionality (PDF, CSV, etc.).
  - Customizable date ranges and filters.
- **Minor (1 pt):** Data export and import functionality.
  - Export data in multiple formats (JSON, CSV, XML, etc.).
  - Import data with validation.
  - Bulk operations support.
- **Minor (1 pt):** GDPR compliance features.
...
### IV.9 Blockchain
- **Major (2 pts):** Store tournament scores on the Blockchain.
...
- **Minor (1 pt):** Use ICP (Internet Computer Protocol) for a backend that runs on a blockchain (incompatible with SSR).

### IV.10 Modules of choice
- **Major (2 pts):** Implement a custom module that is not listed above.
...
- **Minor (1 pt):** Same as the major module but smaller in scope and less complex.
...
> [!NOTE]
> Your `README.md` must be written in English.
